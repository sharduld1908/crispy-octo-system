...
outputDebugString("Executing RndWayPoint.lua (note: this will probably just define functions like runScript(args)\n")

function runScript(args)
	outputDebugString("PE: Progress: RndWayPoint.lua runScript() Entry...\n")
    ...
    outputDebugString("PE: Progress: about to call root.CharacterControl.Events.Event_CREATE_RND_WAYPOINT.Construct\n")
