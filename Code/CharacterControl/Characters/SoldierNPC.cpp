...
namespace CharacterControl {
	...
	namespace Components {
		...
		SoldierNPC::SoldierNPC(PE::GameContext &context, PE::MemoryArena arena, PE::Handle hMyself, Event_CreateSoldierNPC *pEvt) : Component(context, arena, hMyself)
		{
			...
			if (m_npcType == "RandomMovementGuard") {
				pSoldierBehaviorSM->m_duty = SoldierNPCBehaviorSM::Soldier_Duties::RANDOM_MOVEMENT_GAURD;
			}
			else if (m_npcType == "shooter") {
				pSoldierBehaviorSM->m_duty = SoldierNPCBehaviorSM::Soldier_Duties::SHOOTER;
			}
			else if (m_npcType == "target") {
				pSoldierBehaviorSM->m_duty = SoldierNPCBehaviorSM::Soldier_Duties::TARGET;
			}
			else {
				pSoldierBehaviorSM->m_duty = SoldierNPCBehaviorSM::Soldier_Duties::GAURD;
			}
